          ...
          <div className="space-between">
            ...
            <span>
              <div>
                ...
                <span className="right-span">{formatNumToString(data.start_price)}$</span>
              </div>
              <div>
                <span className="left-span">Bước giá:</span>
                <span className="right-span">{formatNumToString(data.price_step)}$</span>
              </div>
              <div>
                <span className="left-span">Giá thầu cao nhất hiện tại:</span>
                <span className="right-span">
                  {data.highest_bid
                    ? formatNumToString(data.highest_bid) + "$"
                    : "Chưa có dữ liệu"}
                </span>
              </div>
              <div
